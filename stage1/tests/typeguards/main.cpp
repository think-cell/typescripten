...
int main() {
	 ...
	 static_assert(std::is_same<decltype(std::declval<tc::js::Test const&>()->isFunction(std::declval<tc::js::any>())), std::optional<tc::jst::js_function<double (tc::js::string)> > >::value);
