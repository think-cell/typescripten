...
namespace tc::js_defs {
	...
	struct _impl_js_j_qts_q : virtual IObject {
		struct _tcjs_definitions {
			...
			static auto addEmitHelpers(js_unknown /*flags=262144: T ()*/ node, js_union<js::Array<_js_jts_dEmitHelper>, js_undefined> helpers) noexcept;
			static auto addSyntheticLeadingComment(js_unknown /*flags=262144: T ()*/ node, _js_jts_dSyntaxKind /*SyntaxKind.SingleLineCommentTrivia*/ kind, js_string text, js_union<bool /*false*/, js_undefined> hasTrailingNewLine) noexcept;
			static auto addSyntheticTrailingComment(js_unknown /*flags=262144: T ()*/ node, _js_jts_dSyntaxKind /*SyntaxKind.SingleLineCommentTrivia*/ kind, js_string text, js_union<bool /*false*/, js_undefined> hasTrailingNewLine) noexcept;
			...
			static auto convertCompilerOptionsFromJson(js_unknown jsonOptions, js_string basePath, js_union<js_string, js_undefined> configFileName) noexcept;
			...
			static auto convertTypeAcquisitionFromJson(js_unknown jsonOptions, js_string basePath, js_union<js_string, js_undefined> configFileName) noexcept;
			static auto couldStartTrivia(js_string text, double pos) noexcept;
			static auto createAbstractBuilder(_js_jts_dProgram newProgram, _js_jts_dBuilderProgramHost host, js_union<_js_jts_dBuilderProgram, js_undefined> oldProgram, js_union<js::ReadonlyArray<_js_jts_dDiagnostic>, js_undefined> configFileParsingDiagnostics) noexcept;
			static auto createAbstractBuilder(js_union<js::ReadonlyArray<js_string>, js_undefined> rootNames, js_union<_js_jts_dCompilerOptions, js_undefined> options, js_union<_js_jts_dCompilerHost, js_undefined> host, js_union<_js_jts_dBuilderProgram, js_undefined> oldProgram, js_union<js::ReadonlyArray<_js_jts_dDiagnostic>, js_undefined> configFileParsingDiagnostics, js_union<js::ReadonlyArray<_js_jts_dProjectReference>, js_undefined> projectReferences) noexcept;
			...
			static auto createArrayLiteral(js_union<js::ReadonlyArray<_js_jts_dExpression>, js_undefined> elements, js_union<bool /*false*/, js_undefined> multiLine) noexcept;
			...
			static auto createBlock(js::ReadonlyArray<_js_jts_dStatement> statements, js_union<bool /*false*/, js_undefined> multiLine) noexcept;
			static auto createBreak(js_union<_js_jts_dIdentifier, js_string, js_undefined> label) noexcept;
			static auto createBundle(js::ReadonlyArray<_js_jts_dSourceFile> sourceFiles, js_union<js::ReadonlyArray<js_union<_js_jts_dInputFiles, _js_jts_dUnparsedSource>>, js_undefined> prepends) noexcept;
			static auto createCall(_js_jts_dExpression expression, js_union<js::ReadonlyArray<_js_jts_dTypeNode>, js_undefined> typeArguments, js_union<js::ReadonlyArray<_js_jts_dExpression>, js_undefined> argumentsArray) noexcept;
			static auto createCallSignature(js_union<js::ReadonlyArray<_js_jts_dTypeParameterDeclaration>, js_undefined> typeParameters, js::ReadonlyArray<_js_jts_dParameterDeclaration> parameters, js_union<_js_jts_dTypeNode, js_undefined> type) noexcept;
			...
			static auto createCompilerHost(_js_jts_dCompilerOptions options, js_union<bool /*false*/, js_undefined> setParentNodes) noexcept;
			...
			static auto createConstructSignature(js_union<js::ReadonlyArray<_js_jts_dTypeParameterDeclaration>, js_undefined> typeParameters, js::ReadonlyArray<_js_jts_dParameterDeclaration> parameters, js_union<_js_jts_dTypeNode, js_undefined> type) noexcept;
			static auto createConstructor(js_union<js::ReadonlyArray<_js_jts_dDecorator>, js_undefined> decorators, js_union<js::ReadonlyArray<js_unknown /*flags=1048576: Modifier ()*/>, js_undefined> modifiers, js::ReadonlyArray<_js_jts_dParameterDeclaration> parameters, js_union<_js_jts_dBlock, js_undefined> body) noexcept;
			static auto createConstructorTypeNode(js_union<js::ReadonlyArray<_js_jts_dTypeParameterDeclaration>, js_undefined> typeParameters, js::ReadonlyArray<_js_jts_dParameterDeclaration> parameters, js_union<_js_jts_dTypeNode, js_undefined> type) noexcept;
			static auto createContinue(js_union<_js_jts_dIdentifier, js_string, js_undefined> label) noexcept;
			...
			static auto createDocumentRegistry(js_union<bool /*false*/, js_undefined> useCaseSensitiveFileNames, js_union<js_string, js_undefined> currentDirectory) noexcept;
			static auto createElementAccess(_js_jts_dExpression expression, js_union<_js_jts_dExpression, double> index) noexcept;
			static auto createEmitAndSemanticDiagnosticsBuilderProgram(_js_jts_dProgram newProgram, _js_jts_dBuilderProgramHost host, js_union<_js_jts_dEmitAndSemanticDiagnosticsBuilderProgram, js_undefined> oldProgram, js_union<js::ReadonlyArray<_js_jts_dDiagnostic>, js_undefined> configFileParsingDiagnostics) noexcept;
			...
			static auto createEnumMember(js_union<_js_jts_dComputedPropertyName, _js_jts_dIdentifier, _js_jts_dNumericLiteral, _js_jts_dStringLiteral, js_string> name, js_union<_js_jts_dExpression, js_undefined> initializer) noexcept;
			...
			static auto createFunctionTypeNode(js_union<js::ReadonlyArray<_js_jts_dTypeParameterDeclaration>, js_undefined> typeParameters, js::ReadonlyArray<_js_jts_dParameterDeclaration> parameters, js_union<_js_jts_dTypeNode, js_undefined> type) noexcept;
			...
			static auto createIf(_js_jts_dExpression expression, _js_jts_dStatement thenStatement, js_union<_js_jts_dStatement, js_undefined> elseStatement) noexcept;
			...
			static auto createImportClause(js_union<_js_jts_dIdentifier, js_undefined> name, js_union<_js_jts_dNamedImports, _js_jts_dNamespaceImport, js_undefined> namedBindings) noexcept;
			...
			static auto createImportTypeNode(_js_jts_dTypeNode argument, js_union<_js_jts_dIdentifier, _js_jts_dQualifiedName, js_undefined> qualifier, js_union<js::ReadonlyArray<_js_jts_dTypeNode>, js_undefined> typeArguments, js_union<bool /*false*/, js_undefined> isTypeOf) noexcept;
			...
			static auto createInputFiles(js_function<js_union<js_string, js_undefined>(js_string)> readFileText, js_string javascriptPath, js_union<js_string, js_undefined> javascriptMapPath, js_string declarationPath, js_union<js_string, js_undefined> declarationMapPath, js_union<js_string, js_undefined> buildInfoPath) noexcept;
			static auto createInputFiles(js_string javascriptText, js_string declarationText) noexcept;
			static auto createInputFiles(js_string javascriptText, js_string declarationText, js_union<js_string, js_undefined> javascriptMapPath, js_union<js_string, js_undefined> javascriptMapText, js_union<js_string, js_undefined> declarationMapPath, js_union<js_string, js_undefined> declarationMapText) noexcept;
			...
			static auto createJsxExpression(js_unknown /*flags=1048576: Token<SyntaxKind.DotDotDotToken> | undefined ()*/ dotDotDotToken, js_union<_js_jts_dExpression, js_undefined> expression) noexcept;
			...
			static auto createJsxText(js_string text, js_union<bool /*false*/, js_undefined> containsOnlyTriviaWhiteSpaces) noexcept;
			...
			static auto createLanguageService(_js_jts_dLanguageServiceHost host, js_union<_js_jts_dDocumentRegistry, js_undefined> documentRegistry, js_union<bool /*false*/, js_undefined> syntaxOnly) noexcept;
			static auto createLanguageServiceSourceFile(js_string fileName, _js_jts_dIScriptSnapshot scriptSnapshot, _js_jts_dScriptTarget /*ScriptTarget.ES3*/ scriptTarget, js_string version, bool /*false*/ setNodeParents, js_union<_js_jts_dScriptKind /*ScriptKind.TS*/, js_undefined> scriptKind) noexcept;
			...
			static auto createModuleResolutionCache(js_string currentDirectory, js_function<js_string(js_string)> getCanonicalFileName, js_union<_js_jts_dCompilerOptions, js_undefined> options) noexcept;
			...
			static auto createNew(_js_jts_dExpression expression, js_union<js::ReadonlyArray<_js_jts_dTypeNode>, js_undefined> typeArguments, js_union<js::ReadonlyArray<_js_jts_dExpression>, js_undefined> argumentsArray) noexcept;
			static auto createNoSubstitutionTemplateLiteral(js_string text) noexcept;
			static auto createNode(_js_jts_dSyntaxKind /*SyntaxKind.Unknown*/ kind, js_union<double, js_undefined> pos, js_union<double, js_undefined> end) noexcept;
			static auto createNodeArray(js_union<js::ReadonlyArray<js_unknown /*flags=262144: T ()*/>, js_undefined> elements, js_union<bool /*false*/, js_undefined> hasTrailingComma) noexcept;
			...
			static auto createNumericLiteral(js_string value, js_union<_js_jts_dTokenFlags /*TokenFlags.Octal*/, js_undefined> numericLiteralFlags) noexcept;
			...
			static auto createPartiallyEmittedExpression(_js_jts_dExpression expression, js_union<_js_jts_dNode, js_undefined> original) noexcept;
			...
			static auto createPrinter(js_union<_js_jts_dPrinterOptions, js_undefined> printerOptions, js_union<_js_jts_dPrintHandlers, js_undefined> handlers) noexcept;
			static auto createProgram(_js_jts_dCreateProgramOptions createProgramOptions) noexcept;
			static auto createProgram(js::ReadonlyArray<js_string> rootNames, _js_jts_dCompilerOptions options, js_union<_js_jts_dCompilerHost, js_undefined> host, js_union<_js_jts_dProgram, js_undefined> oldProgram, js_union<js::ReadonlyArray<_js_jts_dDiagnostic>, js_undefined> configFileParsingDiagnostics) noexcept;
			...
			static auto createReturn(js_union<_js_jts_dExpression, js_undefined> expression) noexcept;
			static auto createScanner(_js_jts_dScriptTarget /*ScriptTarget.ES3*/ languageVersion, bool /*false*/ skipTrivia, js_union<_js_jts_dLanguageVariant /*LanguageVariant.Standard*/, js_undefined> languageVariant, js_union<js_string, js_undefined> textInitial, js_union<js_function<void(_js_jts_dDiagnosticMessage, double)>, js_undefined> onError, js_union<double, js_undefined> start, js_union<double, js_undefined> length) noexcept;
			static auto createSemanticDiagnosticsBuilderProgram(_js_jts_dProgram newProgram, _js_jts_dBuilderProgramHost host, js_union<_js_jts_dSemanticDiagnosticsBuilderProgram, js_undefined> oldProgram, js_union<js::ReadonlyArray<_js_jts_dDiagnostic>, js_undefined> configFileParsingDiagnostics) noexcept;
			static auto createSemanticDiagnosticsBuilderProgram(js_union<js::ReadonlyArray<js_string>, js_undefined> rootNames, js_union<_js_jts_dCompilerOptions, js_undefined> options, js_union<_js_jts_dCompilerHost, js_undefined> host, js_union<_js_jts_dSemanticDiagnosticsBuilderProgram, js_undefined> oldProgram, js_union<js::ReadonlyArray<_js_jts_dDiagnostic>, js_undefined> configFileParsingDiagnostics, js_union<js::ReadonlyArray<_js_jts_dProjectReference>, js_undefined> projectReferences) noexcept;
			...
			static auto createShorthandPropertyAssignment(js_union<_js_jts_dIdentifier, js_string> name, js_union<_js_jts_dExpression, js_undefined> objectAssignmentInitializer) noexcept;
			static auto createSourceFile(js_string fileName, js_string sourceText, _js_jts_dScriptTarget /*ScriptTarget.ES3*/ languageVersion, js_union<bool /*false*/, js_undefined> setParentNodes, js_union<_js_jts_dScriptKind /*ScriptKind.TS*/, js_undefined> scriptKind) noexcept;
			static auto createSourceMapSource(js_string fileName, js_string text, js_union<js_function<double(double)>, js_undefined> skipTrivia) noexcept;
			...
			static auto createTempVariable(js_union<js_function<void(_js_jts_dIdentifier)>, js_undefined> recordTempVariable) noexcept;
			...
			static auto createTry(_js_jts_dBlock tryBlock, js_union<_js_jts_dCatchClause, js_undefined> catchClause, js_union<_js_jts_dBlock, js_undefined> finallyBlock) noexcept;
			...
			static auto createTypeLiteralNode(js_union<js::ReadonlyArray<_js_jts_dTypeElement>, js_undefined> members) noexcept;
			...
			static auto createTypeParameterDeclaration(js_union<_js_jts_dIdentifier, js_string> name, js_union<_js_jts_dTypeNode, js_undefined> constraint, js_union<_js_jts_dTypeNode, js_undefined> defaultType) noexcept;
			...
			static auto createTypeReferenceNode(js_union<_js_jts_dIdentifier, _js_jts_dQualifiedName, js_string> typeName, js_union<js::ReadonlyArray<_js_jts_dTypeNode>, js_undefined> typeArguments) noexcept;
			...
			static auto createUnparsedSourceFile(_js_jts_dInputFiles inputFile, js_string /*"js"*/ type, js_union<bool /*false*/, js_undefined> stripInternal) noexcept;
			static auto createUnparsedSourceFile(js_string text) noexcept;
			static auto createUnparsedSourceFile(js_string text, js_union<js_string, js_undefined> mapPath, js_union<js_string, js_undefined> map) noexcept;
			static auto createVariableDeclaration(js_union<_js_jts_dArrayBindingPattern, _js_jts_dIdentifier, _js_jts_dObjectBindingPattern, js_string> name, js_union<_js_jts_dTypeNode, js_undefined> type, js_union<_js_jts_dExpression, js_undefined> initializer) noexcept;
			static auto createVariableDeclarationList(js::ReadonlyArray<_js_jts_dVariableDeclaration> declarations, js_union<_js_jts_dNodeFlags /*NodeFlags.YieldContext*/, js_undefined> flags) noexcept;
			...
			static auto createYield(js_union<_js_jts_dExpression, js_undefined> expression) noexcept;
			...
			static auto displayPartsToString(js_union<js::Array<_js_jts_dSymbolDisplayPart>, js_undefined> displayParts) noexcept;
			...
			static auto findConfigFile(js_string searchPath, js_function<bool /*false*/(js_string)> fileExists, js_union<js_string, js_undefined> configName) noexcept;
			...
			static auto forEachChild(_js_jts_dNode node, js_function<js_unknown /*flags=1048576: T | undefined ()*/(_js_jts_dNode)> cbNode, js_union<js_function<js_unknown /*flags=1048576: T | undefined ()*/(js_unknown /*flags=524288: NodeArray<Node> (TypeReference=ts.NodeArray)*/)>, js_undefined> cbNodes) noexcept;
			...
			static auto getDefaultFormatCodeSettings(js_union<js_string, js_undefined> newLineCharacter) noexcept;
			...
			static auto getGeneratedNameForNode(js_union<_js_jts_dNode, js_undefined> node) noexcept;
			...
			static auto getOriginalNode(js_union<_js_jts_dNode, js_undefined> node) noexcept;
			...
			static auto getParseTreeNode(js_union<_js_jts_dNode, js_undefined> node, js_union<js_function<bool /*false*/(_js_jts_dNode)>, js_undefined> nodeTest) noexcept;
			static auto getParsedCommandLineOfConfigFile(js_string configFileName, _js_jts_dCompilerOptions optionsToExtend, _js_jts_dParseConfigFileHost host, js_unknown /*flags=1048576: Map<ExtendedConfigCacheEntry> | undefined ()*/ extendedConfigCache) noexcept;
			static auto getPositionOfLineAndCharacter(_js_jts_dSourceFileLike sourceFile, double line, double character) noexcept;
			static auto getPreEmitDiagnostics(_js_jts_dProgram program, js_union<_js_jts_dSourceFile, js_undefined> sourceFile, js_union<_js_jts_dCancellationToken, js_undefined> cancellationToken) noexcept;
			...
			static auto isIdentifierPart(double ch, js_union<_js_jts_dScriptTarget /*ScriptTarget.ES2017*/, js_undefined> languageVersion) noexcept;
			static auto isIdentifierStart(double ch, js_union<_js_jts_dScriptTarget /*ScriptTarget.ES2017*/, js_undefined> languageVersion) noexcept;
			...
			static auto nodeModuleNameResolver(js_string moduleName, js_string containingFile, _js_jts_dCompilerOptions compilerOptions, _js_jts_dModuleResolutionHost host, js_union<_js_jts_dModuleResolutionCache, js_undefined> cache, js_union<_js_jts_dResolvedProjectReference, js_undefined> redirectedReference) noexcept;
			static auto parseCommandLine(js::ReadonlyArray<js_string> commandLine, js_union<js_function<js_union<js_string, js_undefined>(js_string)>, js_undefined> readFile) noexcept;
			...
			static auto preProcessFile(js_string sourceText, js_union<bool /*false*/, js_undefined> readImportFiles, js_union<bool /*false*/, js_undefined> detectJavaScriptImports) noexcept;
			...
			static auto resolveModuleName(js_string moduleName, js_string containingFile, _js_jts_dCompilerOptions compilerOptions, _js_jts_dModuleResolutionHost host, js_union<_js_jts_dModuleResolutionCache, js_undefined> cache, js_union<_js_jts_dResolvedProjectReference, js_undefined> redirectedReference) noexcept;
			...
			static auto resolveTypeReferenceDirective(js_string typeReferenceDirectiveName, js_union<js_string, js_undefined> containingFile, _js_jts_dCompilerOptions options, _js_jts_dModuleResolutionHost host, js_union<_js_jts_dResolvedProjectReference, js_undefined> redirectedReference) noexcept;
			...
			static auto setOriginalNode(js_unknown /*flags=262144: T ()*/ node, js_union<_js_jts_dNode, js_undefined> original) noexcept;
			static auto setSourceMapRange(js_unknown /*flags=262144: T ()*/ node, js_union<_js_jts_dSourceMapRange, js_undefined> range) noexcept;
			static auto setSyntheticLeadingComments(js_unknown /*flags=262144: T ()*/ node, js_union<js::Array<_js_jts_dSynthesizedComment>, js_undefined> comments) noexcept;
			static auto setSyntheticTrailingComments(js_unknown /*flags=262144: T ()*/ node, js_union<js::Array<_js_jts_dSynthesizedComment>, js_undefined> comments) noexcept;
			static auto setTextRange(js_unknown /*flags=262144: T ()*/ range, js_union<_js_jts_dTextRange, js_undefined> location) noexcept;
			static auto setTokenSourceMapRange(js_unknown /*flags=262144: T ()*/ node, _js_jts_dSyntaxKind /*SyntaxKind.Unknown*/ token, js_union<_js_jts_dSourceMapRange, js_undefined> range) noexcept;
			...
			static auto transform(js_unknown /*flags=1048576: T | T[] ()*/ source, js::Array<js_unknown /*flags=524288: TransformerFactory<T> ()*/> transformers, js_union<_js_jts_dCompilerOptions, js_undefined> compilerOptions) noexcept;
			static auto transpile(js_string input, js_union<_js_jts_dCompilerOptions, js_undefined> compilerOptions, js_union<js_string, js_undefined> fileName, js_union<js::Array<_js_jts_dDiagnostic>, js_undefined> diagnostics, js_union<js_string, js_undefined> moduleName) noexcept;
			...
			static auto updateBreak(_js_jts_dBreakStatement node, js_union<_js_jts_dIdentifier, js_undefined> label) noexcept;
			static auto updateBundle(_js_jts_dBundle node, js::ReadonlyArray<_js_jts_dSourceFile> sourceFiles, js_union<js::ReadonlyArray<js_union<_js_jts_dInputFiles, _js_jts_dUnparsedSource>>, js_undefined> prepends) noexcept;
			...
			static auto updateContinue(_js_jts_dContinueStatement node, js_union<_js_jts_dIdentifier, js_undefined> label) noexcept;
			...
			static auto updateEnumMember(_js_jts_dEnumMember node, js_union<_js_jts_dComputedPropertyName, _js_jts_dIdentifier, _js_jts_dNumericLiteral, _js_jts_dStringLiteral> name, js_union<_js_jts_dExpression, js_undefined> initializer) noexcept;
			...
			static auto updateExportDeclaration(_js_jts_dExportDeclaration node, js_union<js::ReadonlyArray<_js_jts_dDecorator>, js_undefined> decorators, js_union<js::ReadonlyArray<js_unknown /*flags=1048576: Modifier ()*/>, js_undefined> modifiers, js_union<_js_jts_dNamedExports, js_undefined> exportClause, js_union<_js_jts_dExpression, js_undefined> moduleSpecifier) noexcept;
			...
			static auto updateFunctionTypeNode(_js_jts_dFunctionTypeNode node, js_unknown /*flags=1048576: NodeArray<TypeParameterDeclaration> | undefined ()*/ typeParameters, js_unknown /*flags=524288: NodeArray<ParameterDeclaration> (TypeReference=ts.NodeArray)*/ parameters, js_union<_js_jts_dTypeNode, js_undefined> type) noexcept;
			...
			static auto updateIf(_js_jts_dIfStatement node, _js_jts_dExpression expression, _js_jts_dStatement thenStatement, js_union<_js_jts_dStatement, js_undefined> elseStatement) noexcept;
			static auto updateImportClause(_js_jts_dImportClause node, js_union<_js_jts_dIdentifier, js_undefined> name, js_union<_js_jts_dNamedImports, _js_jts_dNamespaceImport, js_undefined> namedBindings) noexcept;
			...
			static auto updateImportTypeNode(_js_jts_dImportTypeNode node, _js_jts_dTypeNode argument, js_union<_js_jts_dIdentifier, _js_jts_dQualifiedName, js_undefined> qualifier, js_union<js::ReadonlyArray<_js_jts_dTypeNode>, js_undefined> typeArguments, js_union<bool /*false*/, js_undefined> isTypeOf) noexcept;
			...
			static auto updateJsxExpression(_js_jts_dJsxExpression node, js_union<_js_jts_dExpression, js_undefined> expression) noexcept;
			...
			static auto updateJsxText(_js_jts_dJsxText node, js_string text, js_union<bool /*false*/, js_undefined> containsOnlyTriviaWhiteSpaces) noexcept;
			static auto updateLabel(_js_jts_dLabeledStatement node, _js_jts_dIdentifier label, _js_jts_dStatement statement) noexcept;
			static auto updateLanguageServiceSourceFile(_js_jts_dSourceFile sourceFile, _js_jts_dIScriptSnapshot scriptSnapshot, js_string version, js_union<_js_jts_dTextChangeRange, js_undefined> textChangeRange, js_union<bool /*false*/, js_undefined> aggressiveChecks) noexcept;
			...
			static auto updateNew(_js_jts_dNewExpression node, _js_jts_dExpression expression, js_union<js::ReadonlyArray<_js_jts_dTypeNode>, js_undefined> typeArguments, js_union<js::ReadonlyArray<_js_jts_dExpression>, js_undefined> argumentsArray) noexcept;
			...
			static auto updateReturn(_js_jts_dReturnStatement node, js_union<_js_jts_dExpression, js_undefined> expression) noexcept;
			static auto updateSetAccessor(_js_jts_dSetAccessorDeclaration node, js_union<js::ReadonlyArray<_js_jts_dDecorator>, js_undefined> decorators, js_union<js::ReadonlyArray<js_unknown /*flags=1048576: Modifier ()*/>, js_undefined> modifiers, js_union<_js_jts_dComputedPropertyName, _js_jts_dIdentifier, _js_jts_dNumericLiteral, _js_jts_dStringLiteral> name, js::ReadonlyArray<_js_jts_dParameterDeclaration> parameters, js_union<_js_jts_dBlock, js_undefined> body) noexcept;
			static auto updateShorthandPropertyAssignment(_js_jts_dShorthandPropertyAssignment node, _js_jts_dIdentifier name, js_union<_js_jts_dExpression, js_undefined> objectAssignmentInitializer) noexcept;
			static auto updateSourceFile(_js_jts_dSourceFile sourceFile, js_string newText, _js_jts_dTextChangeRange textChangeRange, js_union<bool /*false*/, js_undefined> aggressiveChecks) noexcept;
			static auto updateSourceFileNode(_js_jts_dSourceFile node, js::ReadonlyArray<_js_jts_dStatement> statements, js_union<bool /*false*/, js_undefined> isDeclarationFile, js_union<js::ReadonlyArray<_js_jts_dFileReference>, js_undefined> referencedFiles, js_union<js::ReadonlyArray<_js_jts_dFileReference>, js_undefined> typeReferences, js_union<bool /*false*/, js_undefined> hasNoDefaultLib, js_union<js::ReadonlyArray<_js_jts_dFileReference>, js_undefined> libReferences) noexcept;
			...
			static auto updateTry(_js_jts_dTryStatement node, _js_jts_dBlock tryBlock, js_union<_js_jts_dCatchClause, js_undefined> catchClause, js_union<_js_jts_dBlock, js_undefined> finallyBlock) noexcept;
			...
			static auto updateTypeParameterDeclaration(_js_jts_dTypeParameterDeclaration node, _js_jts_dIdentifier name, js_union<_js_jts_dTypeNode, js_undefined> constraint, js_union<_js_jts_dTypeNode, js_undefined> defaultType) noexcept;
			...
			static auto updateTypeReferenceNode(_js_jts_dTypeReferenceNode node, js_union<_js_jts_dIdentifier, _js_jts_dQualifiedName> typeName, js_unknown /*flags=1048576: NodeArray<TypeNode> | undefined ()*/ typeArguments) noexcept;
			...
			static auto updateVariableDeclaration(_js_jts_dVariableDeclaration node, js_union<_js_jts_dArrayBindingPattern, _js_jts_dIdentifier, _js_jts_dObjectBindingPattern> name, js_union<_js_jts_dTypeNode, js_undefined> type, js_union<_js_jts_dExpression, js_undefined> initializer) noexcept;
			...
			static auto visitNode(js_unknown /*flags=1048576: T | undefined ()*/ node, js_union<js_function<js_union<_js_jts_dNode, js::Array<_js_jts_dNode>, js_undefined>(_js_jts_dNode)>, js_undefined> visitor, js_union<js_function<bool /*false*/(_js_jts_dNode)>, js_undefined> test, js_union<js_function<js_unknown /*flags=262144: T ()*/(js_unknown /*flags=524288: NodeArray<Node> (TypeReference=ts.NodeArray)*/)>, js_undefined> lift) noexcept;
			static auto visitNodes(js_unknown /*flags=1048576: NodeArray<T> | undefined ()*/ nodes, js_function<js_union<_js_jts_dNode, js::Array<_js_jts_dNode>, js_undefined>(_js_jts_dNode)> visitor, js_union<js_function<bool /*false*/(_js_jts_dNode)>, js_undefined> test, js_union<double, js_undefined> start, js_union<double, js_undefined> count) noexcept;
	...
	struct _impl_js_jts_dNode : virtual _impl_js_jts_dTextRange {
		...
		auto forEachChild(js_function<js_unknown /*flags=1048576: T | undefined ()*/(_js_jts_dNode)> cbNode, js_union<js_function<js_unknown /*flags=1048576: T | undefined ()*/(js_unknown /*flags=524288: NodeArray<Node> (TypeReference=ts.NodeArray)*/)>, js_undefined> cbNodeArray) noexcept;
		auto getChildAt(double index, js_union<_js_jts_dSourceFile, js_undefined> sourceFile) noexcept;
		auto getChildCount(js_union<_js_jts_dSourceFile, js_undefined> sourceFile) noexcept;
		auto getChildren(js_union<_js_jts_dSourceFile, js_undefined> sourceFile) noexcept;
		auto getEnd() noexcept;
		auto getFirstToken(js_union<_js_jts_dSourceFile, js_undefined> sourceFile) noexcept;
		auto getFullStart() noexcept;
		auto getFullText(js_union<_js_jts_dSourceFile, js_undefined> sourceFile) noexcept;
		auto getFullWidth() noexcept;
		auto getLastToken(js_union<_js_jts_dSourceFile, js_undefined> sourceFile) noexcept;
		auto getLeadingTriviaWidth(js_union<_js_jts_dSourceFile, js_undefined> sourceFile) noexcept;
		auto getSourceFile() noexcept;
		auto getStart(js_union<_js_jts_dSourceFile, js_undefined> sourceFile, js_union<bool /*false*/, js_undefined> includeJsDocComment) noexcept;
		auto getText(js_union<_js_jts_dSourceFile, js_undefined> sourceFile) noexcept;
		auto getWidth(js_union<_js_jts_dSourceFileLike, js_undefined> sourceFile) noexcept;
	};
	...
	struct _impl_js_jts_dParseConfigHost : virtual IObject {
		...
		auto readDirectory(js_string rootDir, js::ReadonlyArray<js_string> extensions, js_union<js::ReadonlyArray<js_string>, js_undefined> excludes, js::ReadonlyArray<js_string> includes, js_union<double, js_undefined> depth) noexcept;
	...
	struct _impl_js_jts_dProgram : virtual _impl_js_jts_dScriptReferenceHost {
		...
		auto getDeclarationDiagnostics(js_union<_js_jts_dSourceFile, js_undefined> sourceFile, js_union<_js_jts_dCancellationToken, js_undefined> cancellationToken) noexcept;
		auto getGlobalDiagnostics(js_union<_js_jts_dCancellationToken, js_undefined> cancellationToken) noexcept;
		auto getOptionsDiagnostics(js_union<_js_jts_dCancellationToken, js_undefined> cancellationToken) noexcept;
		auto getProjectReferences() noexcept;
		auto getResolvedProjectReferences() noexcept;
		auto getRootFileNames() noexcept;
		auto getSemanticDiagnostics(js_union<_js_jts_dSourceFile, js_undefined> sourceFile, js_union<_js_jts_dCancellationToken, js_undefined> cancellationToken) noexcept;
		auto getSourceFiles() noexcept;
		auto getSyntacticDiagnostics(js_union<_js_jts_dSourceFile, js_undefined> sourceFile, js_union<_js_jts_dCancellationToken, js_undefined> cancellationToken) noexcept;
	...
	struct _impl_js_jts_dTypeChecker : virtual IObject {
		...
		auto indexInfoToIndexSignatureDeclaration(_js_jts_dIndexInfo indexInfo, _js_jts_dIndexKind /*IndexKind.String*/ kind, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dNodeBuilderFlags /*NodeBuilderFlags.OmitParameterModifiers*/, js_undefined> flags) noexcept;
		...
		auto signatureToSignatureDeclaration(_js_jts_dSignature signature, _js_jts_dSyntaxKind /*SyntaxKind.Unknown*/ kind, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dNodeBuilderFlags /*NodeBuilderFlags.OmitParameterModifiers*/, js_undefined> flags) noexcept;
		auto signatureToString(_js_jts_dSignature signature, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dTypeFormatFlags /*TypeFormatFlags.UseTypeOfFunction*/, js_undefined> flags, js_union<_js_jts_dSignatureKind /*SignatureKind.Call*/, js_undefined> kind) noexcept;
		auto symbolToEntityName(_js_jts_dSymbol symbol, _js_jts_dSymbolFlags /*SymbolFlags.None*/ meaning, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dNodeBuilderFlags /*NodeBuilderFlags.OmitParameterModifiers*/, js_undefined> flags) noexcept;
		auto symbolToExpression(_js_jts_dSymbol symbol, _js_jts_dSymbolFlags /*SymbolFlags.None*/ meaning, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dNodeBuilderFlags /*NodeBuilderFlags.OmitParameterModifiers*/, js_undefined> flags) noexcept;
		auto symbolToParameterDeclaration(_js_jts_dSymbol symbol, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dNodeBuilderFlags /*NodeBuilderFlags.OmitParameterModifiers*/, js_undefined> flags) noexcept;
		auto symbolToString(_js_jts_dSymbol symbol, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dSymbolFlags /*SymbolFlags.Transient*/, js_undefined> meaning, js_union<_js_jts_dSymbolFormatFlags /*SymbolFormatFlags.None*/, js_undefined> flags) noexcept;
		auto symbolToTypeParameterDeclarations(_js_jts_dSymbol symbol, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dNodeBuilderFlags /*NodeBuilderFlags.OmitParameterModifiers*/, js_undefined> flags) noexcept;
		auto tryGetMemberInModuleExports(js_string memberName, _js_jts_dSymbol moduleSymbol) noexcept;
		auto typeParameterToDeclaration(_js_jts_dTypeParameter parameter, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dNodeBuilderFlags /*NodeBuilderFlags.OmitParameterModifiers*/, js_undefined> flags) noexcept;
		auto typePredicateToString(js_union<_js_jts_dIdentifierTypePredicate, _js_jts_dThisTypePredicate> predicate, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dTypeFormatFlags /*TypeFormatFlags.UseTypeOfFunction*/, js_undefined> flags) noexcept;
		auto typeToString(_js_jts_dType type, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dTypeFormatFlags /*TypeFormatFlags.UseTypeOfFunction*/, js_undefined> flags) noexcept;
		auto typeToTypeNode(_js_jts_dType type, js_union<_js_jts_dNode, js_undefined> enclosingDeclaration, js_union<_js_jts_dNodeBuilderFlags /*NodeBuilderFlags.OmitParameterModifiers*/, js_undefined> flags) noexcept;
	};
	...
	struct _impl_js_jts_dSymbol : virtual IObject {
		...
		auto getDocumentationComment(js_union<_js_jts_dTypeChecker, js_undefined> typeChecker) noexcept;
	...
	struct _impl_js_jts_dCompilerHost : virtual _impl_js_jts_dModuleResolutionHost {
		...
		auto getSourceFile(js_string fileName, _js_jts_dScriptTarget /*ScriptTarget.ES3*/ languageVersion, js_union<js_function<void(js_string)>, js_undefined> onError, js_union<bool /*false*/, js_undefined> shouldCreateNewSourceFile) noexcept;
		auto useCaseSensitiveFileNames() noexcept;
	};
	...
	struct _impl_js_jts_dSystem : virtual IObject {
		...
		auto exit(js_union<double, js_undefined> exitCode) noexcept;
		auto fileExists(js_string path) noexcept;
		auto getCurrentDirectory() noexcept;
		auto getDirectories(js_string path) noexcept;
		auto getExecutingFilePath() noexcept;
		auto readDirectory(js_string path, js_union<js::ReadonlyArray<js_string>, js_undefined> extensions, js_union<js::ReadonlyArray<js_string>, js_undefined> exclude, js_union<js::ReadonlyArray<js_string>, js_undefined> include, js_union<double, js_undefined> depth) noexcept;
		auto readFile(js_string path, js_union<js_string, js_undefined> encoding) noexcept;
		auto resolvePath(js_string path) noexcept;
		auto write(js_string s) noexcept;
		auto writeFile(js_string path, js_string data, js_union<bool /*false*/, js_undefined> writeByteOrderMark) noexcept;
	};
	...
	struct _impl_js_jts_dScanner : virtual IObject {
		...
		auto setOnError(js_union<js_function<void(_js_jts_dDiagnosticMessage, double)>, js_undefined> onError) noexcept;
		auto setScriptTarget(_js_jts_dScriptTarget /*ScriptTarget.ES3*/ scriptTarget) noexcept;
		auto setText(js_union<js_string, js_undefined> text, js_union<double, js_undefined> start, js_union<double, js_undefined> length) noexcept;
	...
	struct _impl_js_jts_dNonRelativeModuleNameResolutionCache : virtual IObject {
		...
		auto getOrCreateCacheForModuleName(js_string nonRelativeModuleName, js_union<_js_jts_dResolvedProjectReference, js_undefined> redirectedReference) noexcept;
	};
	struct _impl_js_jts_dModuleResolutionCache : virtual _impl_js_jts_dNonRelativeModuleNameResolutionCache {
		struct _tcjs_definitions {
		};
		auto getOrCreateCacheForDirectory(js_string directoryName, js_union<_js_jts_dResolvedProjectReference, js_undefined> redirectedReference) noexcept;
	};
	...
	struct _impl_js_jts_dSemanticDiagnosticsBuilderProgram : virtual _impl_js_jts_dBuilderProgram {
		...
		auto getSemanticDiagnosticsOfNextAffectedFile(js_union<_js_jts_dCancellationToken, js_undefined> cancellationToken, js_union<js_function<bool /*false*/(_js_jts_dSourceFile)>, js_undefined> ignoreSourceFile) noexcept;
	};
	...
	struct _impl_js_jts_dWatchHost : virtual IObject {
		...
		auto watchDirectory(js_string path, js_function<void(js_string)> callback, js_union<bool /*false*/, js_undefined> recursive) noexcept;
		auto watchFile(js_string path, js_function<void(js_string, _js_jts_dFileWatcherEventKind /*FileWatcherEventKind.Created*/)> callback, js_union<double, js_undefined> pollingInterval) noexcept;
	};
	...
	struct _impl_js_jts_dLanguageService : virtual IObject {
		...
		auto applyCodeActionCommand(_js_jts_dInstallPackageAction action, js_union<_js_jts_dFormatCodeSettings, js_undefined> formatSettings) noexcept;
		auto applyCodeActionCommand(js::Array<_js_jts_dInstallPackageAction> action, js_union<_js_jts_dFormatCodeSettings, js_undefined> formatSettings) noexcept;
		...
		auto applyCodeActionCommand(js_union<_js_jts_dInstallPackageAction, js::Array<_js_jts_dInstallPackageAction>> action, js_union<_js_jts_dFormatCodeSettings, js_undefined> formatSettings) noexcept;
		auto cleanupSemanticCache() noexcept;
		auto dispose() noexcept;
		auto findReferences(js_string fileName, double position) noexcept;
		auto findRenameLocations(js_string fileName, double position, bool /*false*/ findInStrings, bool /*false*/ findInComments, js_union<bool /*false*/, js_undefined> providePrefixAndSuffixTextForRename) noexcept;
		auto getApplicableRefactors(js_string fileName, js_union<_js_jts_dTextRange, double> positionOrRange, js_union<_js_jts_dUserPreferences, js_undefined> preferences) noexcept;
		...
		auto getCompletionEntryDetails(js_string fileName, double position, js_string name, js_union<_js_jts_dFormatCodeOptions, _js_jts_dFormatCodeSettings, js_undefined> formatOptions, js_union<js_string, js_undefined> source, js_union<_js_jts_dUserPreferences, js_undefined> preferences) noexcept;
		auto getCompletionEntrySymbol(js_string fileName, double position, js_string name, js_union<js_string, js_undefined> source) noexcept;
		auto getCompletionsAtPosition(js_string fileName, double position, js_union<_js_jts_dGetCompletionsAtPositionOptions, js_undefined> options) noexcept;
		...
		auto getEditsForFileRename(js_string oldFilePath, js_string newFilePath, _js_jts_dFormatCodeSettings formatOptions, js_union<_js_jts_dUserPreferences, js_undefined> preferences) noexcept;
		auto getEditsForRefactor(js_string fileName, _js_jts_dFormatCodeSettings formatOptions, js_union<_js_jts_dTextRange, double> positionOrRange, js_string refactorName, js_string actionName, js_union<_js_jts_dUserPreferences, js_undefined> preferences) noexcept;
		auto getEmitOutput(js_string fileName, js_union<bool /*false*/, js_undefined> emitOnlyDtsFiles) noexcept;
		...
		auto getNavigateToItems(js_string searchValue, js_union<double, js_undefined> maxResultCount, js_union<js_string, js_undefined> fileName, js_union<bool /*false*/, js_undefined> excludeDtsFiles) noexcept;
		...
		auto getRenameInfo(js_string fileName, double position, js_union<_js_jts_dRenameInfoOptions, js_undefined> options) noexcept;
		...
		auto getSignatureHelpItems(js_string fileName, double position, js_union<_js_jts_dSignatureHelpItemsOptions, js_undefined> options) noexcept;
		...
		auto organizeImports(_js_jts_dCombinedCodeFixScope scope, _js_jts_dFormatCodeSettings formatOptions, js_union<_js_jts_dUserPreferences, js_undefined> preferences) noexcept;
	};
	...
	struct _impl_js_jts_dDocumentRegistry : virtual IObject {
		...
		auto acquireDocument(js_string fileName, _js_jts_dCompilerOptions compilationSettings, _js_jts_dIScriptSnapshot scriptSnapshot, js_string version, js_union<_js_jts_dScriptKind /*ScriptKind.TS*/, js_undefined> scriptKind) noexcept;
		...
		auto updateDocument(js_string fileName, _js_jts_dCompilerOptions compilationSettings, _js_jts_dIScriptSnapshot scriptSnapshot, js_string version, js_union<_js_jts_dScriptKind /*ScriptKind.TS*/, js_undefined> scriptKind) noexcept;
...
#define OPTIONAL_ARGUMENT tc::jst::js_undefined() // for optional arguments