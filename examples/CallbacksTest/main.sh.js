...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 30512,
    DYNAMIC_BASE = 5273392,
    DYNAMICTOP_PTR = 30496;
...
var asmGlobalArg = {};
var asmLibraryArg = { "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "__assert_fail": ___assert_fail, "__cxa_allocate_exception": ___cxa_allocate_exception, "__cxa_atexit": ___cxa_atexit, "__cxa_pure_virtual": ___cxa_pure_virtual, "__cxa_throw": ___cxa_throw, "__cxa_uncaught_exceptions": ___cxa_uncaught_exceptions, "__lock": ___lock, "__map_file": ___map_file, "__setErrNo": ___setErrNo, "__syscall140": ___syscall140, "__syscall146": ___syscall146, "__syscall54": ___syscall54, "__syscall6": ___syscall6, "__syscall91": ___syscall91, "__unlock": ___unlock, "_addDays": __addDays, "_arraySum": __arraySum, "_embind_register_bool": __embind_register_bool, "_embind_register_emval": __embind_register_emval, "_embind_register_float": __embind_register_float, "_embind_register_function": __embind_register_function, "_embind_register_integer": __embind_register_integer, "_embind_register_memory_view": __embind_register_memory_view, "_embind_register_std_string": __embind_register_std_string, "_embind_register_std_wstring": __embind_register_std_wstring, "_embind_register_void": __embind_register_void, "_emscripten_syscall_munmap": __emscripten_syscall_munmap, "_emval_addMethodCaller": __emval_addMethodCaller, "_emval_allocateDestructors": __emval_allocateDestructors, "_emval_as": __emval_as, "_emval_call": __emval_call, "_emval_call_void_method": __emval_call_void_method, "_emval_decref": __emval_decref, "_emval_get_method_caller": __emval_get_method_caller, "_emval_get_module_property": __emval_get_module_property, "_emval_get_property": __emval_get_property, "_emval_incref": __emval_incref, "_emval_is_string": __emval_is_string, "_emval_lookupTypes": __emval_lookupTypes, "_emval_new": __emval_new, "_emval_new_cstring": __emval_new_cstring, "_emval_not": __emval_not, "_emval_register": __emval_register, "_emval_run_destructors": __emval_run_destructors, "_emval_take_value": __emval_take_value, "_isLeapYear": __isLeapYear, "abort": _abort, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "alignfault": alignfault, "atexit": _atexit, "count_emval_handles": count_emval_handles, "craftEmvalAllocator": craftEmvalAllocator, "craftInvokerFunction": craftInvokerFunction, "createNamedFunction": createNamedFunction, "demangle": demangle, "demangleAll": demangleAll, "embind__requireFunction": embind__requireFunction, "embind_init_charCodes": embind_init_charCodes, "embind_repr": _embind_repr, "emscripten_get_heap_size": _emscripten_get_heap_size, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "ensureOverloadTable": ensureOverloadTable, "exposePublicSymbol": exposePublicSymbol, "extendError": extendError, "fabs": _fabs, "floatReadValueFromPointer": floatReadValueFromPointer, "getShiftFromSize": getShiftFromSize, "getStringOrSymbol": getStringOrSymbol, "getTypeName": getTypeName, "get_first_emval": get_first_emval, "getenv": _getenv, "heap32VectorToArray": heap32VectorToArray, "init_emval": init_emval, "integerReadValueFromPointer": integerReadValueFromPointer, "jsStackTrace": jsStackTrace, "makeLegalFunctionName": makeLegalFunctionName, "memcpy": _memcpy, "memset": _memset, "new_": new_, "pthread_cond_broadcast": _pthread_cond_broadcast, "pthread_cond_wait": _pthread_cond_wait, "readLatin1String": readLatin1String, "registerType": registerType, "replacePublicSymbol": replacePublicSymbol, "requireHandle": requireHandle, "requireRegisteredType": requireRegisteredType, "runDestructors": runDestructors, "sbrk": _sbrk, "segfault": segfault, "setTempRet0": _setTempRet0, "simpleReadValueFromPointer": simpleReadValueFromPointer, "stackTrace": stackTrace, "strftime": _strftime, "strftime_l": _strftime_l, "throwBindingError": throwBindingError, "throwInternalError": throwInternalError, "throwUnboundTypeError": throwUnboundTypeError, "whenDependentTypesAreResolved": whenDependentTypesAreResolved };
...
var real_dynCall_viiidii = asm["dynCall_viiidii"];
asm["dynCall_viiidii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_viiidii.apply(null, arguments);
};
...
var real_dynCall_viidii = asm["dynCall_viidii"];
asm["dynCall_viidii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_viidii.apply(null, arguments);
};
